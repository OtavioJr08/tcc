...
<head>
    ...
    <!-- Title -->
    <title>Brain's Education - Verificar Conta</title>
                    ...
                    <div class="breadcrumb-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Verificar E-mail</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="contact_from_area mb-100 clearfix">
                        ...
                        <p>Que bom que você se cadastrou! Antes de começar a utilizar o Brain's Education, você precisa confirmar seu e-mail.
                        Enviamos para <b><?php echo $_GET['email'];?></b> uma mensagem que contém o link de verificação!</p>
