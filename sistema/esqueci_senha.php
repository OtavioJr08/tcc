...
<head>
    ...
    <!-- Title -->
    <title>Brain's Education - Nova senha</title>
                    ...
                    <div class="breadcrumb-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Esqueci minha senha</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="contact_from_area mb-100 clearfix">
                        ...
                        <p>Digite seu e-mail abaixo e lhe enviaremos o link para alterar sua senha.</p>
                        
                        <form action="php_home/php_emailAlterarSenha.php" method="post">
                            <div class="contact_input_area">
                                <div class="row">
                                    ...
                                    <!-- Button -->
                                    <div class="col-12">
                                        <button type="submit" class="btn confer-btn" name="btn_enviar">Solicitar<i class="zmdi zmdi-long-arrow-right"></i></button>
                                    </div>
                                </div>
                            </div>
                        </form>
                        <br>
                        <p style="text-align:center">Voltar para a<a href="index.php"> página inicial</a></p>
                    </div>
                </div>
            </div>
        </div>
