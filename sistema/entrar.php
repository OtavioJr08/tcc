...
<head>
    ...
    <!-- Title -->
    <title>Brain's Education - Entrar</title>
                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            <ul id="nav">
                                ...
                                <li class="active"><a href="entrar.php">Entrar</a></li>
                ...
                <div class="col-12 col-lg-6">
                    <div class="contact_from_area mb-100 clearfix">
                        <div class="contact_form">
                            <form action="php_home/php_entrar.php" method="post">
                                <?php
                                ...
                                <div class="contact_input_area">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <div class="form-group">
                                                <a href="esqueci_senha.php" rel="noopener noreferrer">Esqueci minha senha</a>
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-6">
                                            <div class="form-group">
                                                <a href="cadastrar.php" rel="noopener noreferrer">Cadastrar agora</a>
                                            </div>
                                        </div>
                                        <!-- Button -->
                                        <div class="col-12">
                                            <button type="submit" class="btn confer-btn" name="btn_enviar">Entrar<i class="zmdi zmdi-long-arrow-right"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
