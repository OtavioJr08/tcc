...
<head>
    ...
    <!-- Title -->
    <title>Brain's Education - Cadastrar</title>
                ...
                <div class="col-12 col-lg-6">
                    <div class="contact_from_area mb-100 clearfix">
                        <div class="contact_form">
                            <form action="php_home/php_cadastrar.php" method="post">
                                <?php   
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control mb-30" name="inp_nome" id="name" placeholder="Nome" required>
                                            </div>
                                        </div>
                                        <!-- Form Group -->
                                        <div class="col-12 col-lg-6">
                                            <div class="form-group">
                                                <input type="email" class="form-control mb-30" name="inp_email" id="email" placeholder="E-mail" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <div class="form-group">
                                                <input type="password" class="form-control mb-30" name="inp_senha" id="subject" placeholder="Senha">
                                            </div>
                                        </div>
                                        <!-- Form Group -->
                                        <div class="col-12 col-lg-6">
                                            <div class="form-group">
                                                <input type="password" class="form-control mb-30" name="inp_confSenha" id="subject" placeholder="Confirmar senha">
                                            </div>
                                        ...
                                        <!-- Button -->
                                        <div class="col-12">
                                            <button type="submit" class="btn confer-btn" name="btn_cadastrar">Cadastrar-se <i class="zmdi zmdi-long-arrow-right"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#formulario').submit(function() {
                ...
                $.ajax({
                    type : 'POST',
                    url  : 'php_home/php_emailContato.php',
                    data : dados,
                    dataType: 'json',
